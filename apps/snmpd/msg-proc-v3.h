...
#ifndef __MSG_PROC_V3_H__
#define	__MSG_PROC_V3_H__
...
/**
 * Takes the input SNMPv3 message as an array of bytes and decodes it to the message_t structure.
 ...
 * \hideinitializer
 */
s8t prepareDataElements_v3(u8t* const input, const u16t len, u16t* pos, message_v3_t* request);
